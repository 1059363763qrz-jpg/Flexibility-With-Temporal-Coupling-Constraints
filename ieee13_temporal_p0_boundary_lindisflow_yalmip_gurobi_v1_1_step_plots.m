%% ieee13_temporal_p0_boundary_lindisflow_yalmip_gurobi_v1_1_step_plots.m
% IEEE-13 simplified balanced-feeder temporal P0 trajectory-boundary Step 1.
%
% This v1_1_step_plots version keeps the same optimization model and Step 1
% boundary objectives as v1, but improves temporal visualization only. Boundary
% curves are drawn as stairs/step plots because the optimized quantities are
% discrete-period values that remain constant within each time interval before
% jumping at the next period. This version also adds an all-boundary P0
% trajectory plot to show that projected P0 bounds usually come from different
% complete multi-period trajectories.
%
...
%% --------------------------- User parameters ---------------------------
RESULT_DIR = 'results_ieee13_temporal_p0_boundary_lindisflow_v1_1_step_plots';
